...
.tt th{
  ...
  <body>
	...
	<a style="margin-top:0.9%;"  class="pull-right navbar-brand"> Patient Dashboard</a>
	</div>
	</div>
	</div>
  ...
  <ul style="margin-top:-12%;" class="nav nav-stacked nav-pills nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#papt" aria-controls="papt" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;View All Appointments</a></li>
    <li role="presentation" ><a href="#apt" aria-controls="apt" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Today's Appointments</a></li>
    <li role="presentation"><a href="#upapt" aria-controls="apt" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Upcoming Appointments</a></li>
    <li role="presentation"><a href="#missapt" aria-controls="apt" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Missed Appointments</a></li>
    <li role="presentation"><a href="#makeap" aria-controls="makeap" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Make Appointment</a></li>
    <li role="presentation"><a href="#comap" aria-controls="comap" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Completed Appointments</a></li>
    <li role="presentation"><a href="#canap" aria-controls="canap" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Canceled Appointments</a></li>
	<!-- <li role="presentation"><a href="#msger" aria-controls="msg" role="tab" data-toggle="tab"></span>&nbsp;&nbsp;Messenger <span class="badge"><?php echo $pen;?></span></a></li> -->
  ...
  <div style="margin-top:-10%;" class="tab-content">
   ...
   <table class="tt table-hover" border="1" cellspacing="0">
	<tr>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment ID</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Date</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Time</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment With</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Doctor Contact No.</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Status</th>
		</tr>
		<?php
		include('includes/conn.php');
   ...
   <table class="tt table-hover" border="1" cellspacing="0">
	...
	<table class="tt table-hover" border="1" cellspacing="0">
	<tr>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appointment No</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appo. Date</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appo. Time</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appo. With</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Uploded Report By You</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Clinic Address</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Doctor Contact No.</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Status</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Cancel</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Trans. ID</th>
		</tr>
		<?php
		include('includes/conn.php');
	...
	<table class="tt table-hover" border="1" cellspacing="0">
	<tr>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">App.No</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appo. Date</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appo. Time</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Appo. With</th>
		<th width="15%" style="font-size:12px;text-align:center; color:white; background:#337ab7;">Clinic Address</th>
	...
	<tr>
		...
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Time</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment With</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Clinic Address</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Doctor Contact No.</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Status</th>
		</tr>
		<?php
	...
	<tr>
		...
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Time</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment With</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Uploaded reports by you</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Appointment Status</th>
		<th width="15%" style="text-align:center; color:white; background:#337ab7;">Trans. ID</th>
		</tr>
		<?php
		include('includes/conn.php');
