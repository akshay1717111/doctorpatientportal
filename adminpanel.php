...
<ul style="margin-top:-3%;" class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#static" aria-controls="home" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-stats"></span> Statistics</a></li>
    <li role="presentation"><a href="#mdoc" aria-controls="mdoc" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-cog"></span> Doctors List</a></li>
    <li role="presentation"><a href="#verify" aria-controls="verify" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;Doctor verified</a></li>
    <li role="presentation"><a href="#patient" aria-controls="patient" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-cog"></span>Patients List</a></li>
    <li role="presentation"><a href="#feed" aria-controls="feed" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-cog"></span>Feedbacks</a></li>
  </ul>
<div class="tab-content">
<div style="margin-top:1%;" role="tabpanel" class="tab-pane fade in active well" id="static">
<h2 style="margin-top:-0.5%;">Application Statistics</h2>
<div class="row">
<div class="col-md-6">
...
<div class="panel panel-info">
  ...
  <?php
$con = mysqli_connect("localhost", "root", "root",'dpp');
