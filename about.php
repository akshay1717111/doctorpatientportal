...
.navbar-inverse .navbar-nav > .open > a:hover{
 ...
 .tt td{
  ...
  <body>
	...
	<b>About Portal :</b>
	The Doctor Patient Portal is a straightforward portal that enables patients who wait in long lines at clinics and hospitals to book appointments with doctors. 
	This portal helps a reduction in hospital lines. a quick registration process that is free and includes lifelong membership for both the patient and the doctor. Our platform becomes more trustworthy when verified doctors with a huge reputation are used. We offer free services, including a website where they may manage their own schedules. A personalized message system that aids in following a doctor's precautionary advice or for other health-related discussions. Additionally, it is a step toward a paperless workplace in USA.</p>
	</center>
