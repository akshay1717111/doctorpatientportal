...
.aa:hover{
  ...
  <body>
    ...
    <div  style=" border-top-left-radius:0.5em; border-top-right-radius:0.5em;" class="mainmenu container nav navbar-inverse" data-spy="affix" data-offset-top="100">
	<button type="button" style="background:#18c4fd; border-color:#18c4fd;" class="navbar-toggle" data-toggle="collapse" data-target="#coo">
	...
	<?php } ?>
		...
		<?php } ?>
	<div class="container">
	<h2 style="color: #ff003d !important;"><a href="#ab" data-toggle="collapse">Welcome To Doctor Patient Portal</h2></a>
...
<img style="margin-left:10%;float:left; margin-top:-5%;opacity:0.8;" width="270px"  src="img/logom.png"/>
	...
	<img style="margin-top:0.0%;"  class="dppbanner" src="img/220355.jpg"/>
...
<div class="col-md-6">
<div style="margin-left:-2%; width:110%; float:left;" class="panel panel-info">
  <div class="panel-heading"><span class="glyphicon glyphicon-ok-sign"></span> Advantages</div>
  <div class="panel-body">
    <div style="font-family:calibri;" class="list-group">
  <button type="button" class="list-group-item"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;&nbsp;Better Patient Communication</button>
  <button type="button" class="list-group-item"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;&nbsp;Greater Focus on Patient Care</button>
  <button type="button" class="list-group-item"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;&nbsp;Improve Clinical Outcomes</button>
  <button type="button" class="list-group-item"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;&nbsp;Optimize Medical Office Workflow</button>
  <button type="button" class="list-group-item"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;&nbsp;Streamline Patient Registration and Administrative Tasks</button>
</div>
  </div>
</div>
</div>
...
<div class="col-md-6">
<div style="margin-left:3%; width:110%; float:left;" class="panel panel-info">
...
$(function () {
  ...
  <div style="width:35%; border-radius:0em;" class="modal-dialog" role="document">
	...
	<p align="center" style="font-family:calibri; margin-top:-18%;"><?php echo "&nbsp;&nbsp;&nbsp;<b>ID : $docid</b>";?></p>
		...
		<label>Phone </label>&nbsp;:  <?php echo "+1-$phone";?><br>
...
<!--patient Profile tab start-->
  ...
  <div style="width:35%; border-radius:0em;" class="modal-dialog" role="document">
	...
	<p align="center" style="font-family:calibri; margin-top:-18%;"><?php echo "&nbsp;&nbsp;&nbsp;<b>A. ID : $adrid</b>";?></p>	</div>
		...
		<label>Phone </label>&nbsp;:  <?php echo "+1-$mob";?><br>
     ...
     <div class="modal-content">
	  ...
	  <div class="modal-body">
	   ...
	   <div class="tab-content">
		...
		<br>
		<form method="POST" action="dp.php" ENCTYPE="multipart/form-data" id="form1">
	   ...
	   <input type="text" name="adridpt" class="form-control" required placeholder="Enter your Last four digits of SNN"><br>
	   ...
	   <input type="radio" value="Female" name="pgender" required> Female <br></br>
		...
		<br>
		 <form method="POST" action="dp.php"  ENCTYPE="multipart/form-data" id="form2">
	   ...
	   <input type="text" name="docid" class="form-control" required placeholder="Enter your Doctor ID"><br>
		<input type="text" name="adrid" class="form-control" required placeholder="Enter your Last four digits of SNN"><br>
